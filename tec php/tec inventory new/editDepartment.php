...
<?php 
  ...
  if (isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM department WHERE department_id='{$id}' LIMIT 1";
        ...
        if(isset($_POST['edit'])){
            ...
            if(!empty($name) && !empty($description) ){
              $update="UPDATE `department` SET `name`='{$name}',`description`='{$description}' WHERE department_id='{$id}' ";
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Department Edit</a>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Department Id (disable)</label>
