...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 20, 2021 at 05:06 PM
...
(6, 'ch01/wchair01/m12/ET/item02', 'item02', 'Electric item', 1000, 'i1000023', 'm12', 'ch01', 'wchair01', '96', '2022-08-24', '2021-01-20', 'ewiz', 5, 'ET', '002', 'NO', 'ET', 'GOOD', 'img/item/itemdownload (1).jpg', 'pdf/pdfPDF Test.pdf', 'img/qr/ch01_wchair01_m12_ET_item02.png', 'ad01', 7);
...
('ad01', 'pawan sandeepa', 'Admin', 'ICT', 717985631, 'foruniversity@gmail.com', 1, 'WorKing', '2020-12-12 00:00:00', '827ccb0eea8a706c4c34a16891f84e7b', 'img/user/staffvlcsnap-2020-12-20-11h20m03s691.png'),
...
('SVY01', 'Kumara Pathirana', 'Survay', 'ICT', 717985632, 'kumara@gmail.com', 1, 'WorKing', '2021-01-20 03:51:20', '827ccb0eea8a706c4c34a16891f84e7b', 'img/user/staffLatest-Cool-Boys-Profile-25.jpg');
...
('wchair01', 'Wooden chair type 1', 'ch01', 'wooden chair with arms');
...
('sup01', 'Sahan', 'navimana-north', '071-4234569', 'ddpawansandeepa@gmail.com', 'no'),
('sup02', 'Pawan Sandeepa', 'navimana-north', '071-4234569', 'ddpawansandeepa@gmail.com', 'no');
...
CREATE TABLE IF NOT EXISTS `surver_data` (
  `surver_id` varchar(100) NOT NULL,
...
INSERT INTO `surver_data` (`surver_id`, `surve_id`, `date`, `item_id`, `item_name`, `item_department`, `model_name`, `main_catagory`, `catagory`, `move_state`, `warranty`, `add_user`, `move_department`, `current_department`, `current_state`) VALUES
('fvdfv', 'vfdfv', '2020-12-02', '1', 'fvdvf', 'dfvdfv', 'fvdvf', 'fdvdv', 'dfvdfv', 'dfvdvf', 'fvdvf', 'fvfv', 'vdfv', 'vfdfv', '40');
