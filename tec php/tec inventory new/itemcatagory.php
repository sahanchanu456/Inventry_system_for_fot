...
<?PHP
  ...
  if(!empty($log_user_id) && !empty($user_position)){
    if($user_position == "student"){
      ...
      $log_user = "SELECT * FROM staff WHERE staff_id='staf01' AND job_position='admin'";
      $log_user_result = mysqli_query($conn, $log_user) or die (mysqli_error($conn));
      $row = $log_user_result-> fetch_assoc();
    }
  }
...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Manage Item & Catagory</a>
          </div>
              ...
              <li class="nav_search">
                <form>
                  <div class="input-group no-border">
                    <input type="text" class="form-control" placeholder="Search..." onkeyup="search(this.value)"><!---add name get text in search -->
          ...
          <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> ALL Inventory Item</h4>
                          ...
                          while ($item_row = $item_result-> fetch_assoc()){
                            ...
                            echo'<tr>
                             ...
                             echo'<td>
                                ...
                                if($user_position == "Admin" || $user_position == "AB"){
  ...
  <script type='text/javascript'>
    ...
    function search(str) {
        ...
        xmlhttp.open("GET","exphp/itemadcatasearch.php?search="+str,true);
        xmlhttp.send();
    }
        ...
        $(document).ready(function(){
            $("#search_butt").click(function(){
              ...
              var result3 = c.options[c.selectedIndex].value;
                ...
                $("#tabel_body").load("exphp/itemfilteriteancata.php",{
                  //pass vaue
                   cat_N:result1,
                   subcat_N:result2,
                   model_N:result3
