...
<?php
   ...
   if (isset($_GET['id'])) {
      ...
      $query = "SELECT * FROM subcategory WHERE subcategory_id='{$id}' LIMIT 1";
      $result = mysqli_query($conn,$query);

      if ($result) {
        while ($detail = mysqli_fetch_assoc($result)) {
            $name = $detail['name'];
            $main_id=$detail['maincategory_id'];
      ...
      if(isset($_POST['edit'])){
            ...
            if(!empty($name) && !empty($description) ){
              $update="UPDATE `subcategory` SET `name`='{$name}',`maincategory_id`='{$main_id}',`description`='{$description}' WHERE subcategory_id='{$id}' ";
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Sub Catagory Edit</a>
          </div>
                ...
                <form action="" method="post" enctype = "multipart/form-data">
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Sub Catagory Id (disable)</label>
                  ...
                  <div class="row">
                    <div class="col-md-8 pr-1">
                      <div class="form-group">
                        <label>Sub Catagory Discription</label>
                            ...
                            <?php
                              ...
                              if ($result) {
                                while($row=$result->fetch_assoc()){
                                    ...
                                    $name=$row['name'];
                                    if ($category==$main_id) {
                                      echo "<option value=\"".$category."\" selected=\"selected\">".$name."</option>";
                                    }
                                    else{
